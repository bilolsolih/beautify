...
class ProductListTestCase(TestCase):
    def setUp(self) -> None:
        ...
        product = Product.objects.create(
            vendor_code='123', brand=brand, category=category, title=title, description=description, application='test application',
            ingredients='test ingredients', price=123, discount=5,
        )
